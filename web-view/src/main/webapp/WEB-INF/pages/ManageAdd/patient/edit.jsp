    ...
    <tiles:putAttribute name="body">
        <div class="col-md-9 content-nav">
            <fieldset>
                ...
                <c:url var="saveUrl" value="/manage/patient/edit/${editPatients.patientId}"/>
                <form:form method="post" cssClass="form-horizontal" modelAttribute="editPatients"
                           action="${saveUrl}" id="editPatientForm">

                    <div class="form-group padding-form">
                        <label class="col-sm-2 control-label" for="patientId">First name</label>

                        <div class="col-sm-3">
                            <form:input path="patientId" id="patientId" cssClass="form-control" disabled="true"/><span
                                id="errmsg"></span>
